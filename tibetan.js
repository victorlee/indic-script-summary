...
document.getElementById('switch-gha').innerHTML = 'གྷ';
...
document.getElementById('switch-jha').innerHTML = 'ཇྷ';
...
document.getElementById('switch-ḍha').innerHTML = 'ཌྷ';
...
document.getElementById('switch-dha').innerHTML = 'དྷ';
...
document.getElementById('switch-bha').innerHTML = 'བྷ';
...
document.getElementById('switch-ā').innerHTML = 'ཱ';
...
document.getElementById('switch-ī').innerHTML = 'ཱི';
...
document.getElementById('switch-ū').innerHTML = 'ཱུ';
document.getElementById('switch-Xṛ').innerHTML = '';
document.getElementById('switch-ṛ').innerHTML = 'ྲྀ';
document.getElementById('switch-Xṝ').innerHTML = '';
document.getElementById('switch-ṝ').innerHTML = 'ཷ';
document.getElementById('switch-Xḷ').innerHTML = '';
document.getElementById('switch-ḷ').innerHTML = 'ླྀ';
document.getElementById('switch-Xḹ').innerHTML = '';
document.getElementById('switch-ḹ').innerHTML = 'ཹ';
...
`;
//numerals
document.getElementById('switch-0').innerHTML = '༠';
document.getElementById('switch-1').innerHTML = '༡';
document.getElementById('switch-2').innerHTML = '༢';
document.getElementById('switch-3').innerHTML = '༣';
document.getElementById('switch-4').innerHTML = '༤';
document.getElementById('switch-5').innerHTML = '༥';
document.getElementById('switch-6').innerHTML = '༦';
document.getElementById('switch-7').innerHTML = '༧';
document.getElementById('switch-8').innerHTML = '༨';
document.getElementById('switch-9').innerHTML = '༩';
